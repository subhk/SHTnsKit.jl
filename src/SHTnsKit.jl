...
export gpu_spat_to_SH, gpu_SH_to_spat, gpu_spat_to_SH_ml, gpu_SH_to_spat_ml  # GPU scalar transforms
...
export gpu_SHqst_to_lat                                  # GPU QST latitude evaluation
...
gpu_spat_to_SH_ml(::SHTConfig, ::Any, ::Any, ::Any) = error("GPU extension not loaded")
gpu_SH_to_spat_ml(::SHTConfig, ::Any, ::Any, ::Any) = error("GPU extension not loaded")
gpu_spat_to_SH_axisym(::SHTConfig, ::Any) = error("GPU extension not loaded")
gpu_SH_to_spat_axisym(::SHTConfig, ::Any) = error("GPU extension not loaded")
gpu_spat_to_SH_l_axisym(::SHTConfig, ::Any, ::Any) = error("GPU extension not loaded")
...
gpu_spat_to_SHsphtor_ml(::SHTConfig, ::Any, ::Any, ::Any, ::Any) = error("GPU extension not loaded")
gpu_SHsphtor_to_spat_ml(::SHTConfig, ::Any, ::Any, ::Any, ::Any) = error("GPU extension not loaded")
gpu_mul_ct_matrix(::SHTConfig, ::Any) = error("GPU extension not loaded")
gpu_st_dt_matrix(::SHTConfig, ::Any) = error("GPU extension not loaded")
gpu_SH_mul_mx(::SHTConfig, ::Any, ::Any, ::Any) = error("GPU extension not loaded")
